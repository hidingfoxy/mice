...
import net.hidingfox.mice.procedures.JerboaOnEntityTickUpdateProcedure;
...
public class JerboaEntity extends Animal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(10, new RemoveBlockGoal(Blocks.DEAD_BUSH, this, 1, (int) 3));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("mice:entity.jerboa.squeaks"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("mice:entity.jerboa.hurt"));
	}
	...
	public void baseTick() {
		super.baseTick();
		JerboaOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JerboaEntity retval = MiceModEntities.JERBOA.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MiceModEntities.JERBOA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
