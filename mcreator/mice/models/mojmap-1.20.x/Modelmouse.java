	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
						.addBox(-0.5F, -0.9F, -1.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, -1.5F, -7.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(10, 0).addBox(-1.5F, -1.5F, 0.0F, 2.0F, 2.0F, 0.0F,
		...
		PartDefinition torso = body.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 4).addBox(-1.5F,
				-3.0F, -4.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 1.0F, -2.0F));
		...
		PartDefinition cube_r3 = rearleftfoot
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(7, 12).addBox(0.0F, 0.0F, -0.5F, 4.0F, 0.0F, 1.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = frontleftfoot
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(9, 7).addBox(0.0F, 0.0F, -2.0F, 2.0F, 0.0F, 2.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(8, 4).addBox(-0.5F, 1.02F,
				1.3F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, -0.5F, 1.5F));

		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(7, 3).addBox(0.0F, 0.0F, -1.0F, 1.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
