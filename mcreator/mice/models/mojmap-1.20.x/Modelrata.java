...
public class Modelrata<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rata"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(1, 0)
						...
						.addBox(-1.0F, -0.5F, -2.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 12)
						.addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 17)
						.addBox(0.5F, -1.7F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 17)
						.addBox(-1.5F, -1.7F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, -1.5F, -8.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(22, 4).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9502F, -1.7429F, 0.9805F, -0.0873F, 3.0543F, 2.5307F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(18, 4).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition torso = body.addOrReplaceChild("torso",
				CubeListBuilder.create().texOffs(1, 12)
						.addBox(-2.5F, -3.5F, -2.0F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 5)
						.addBox(-2.5F, -3.0F, 1.0F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(1, 5)
						.addBox(-2.0F, -3.0F, -5.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = rearleftfoot
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(21, 0).addBox(-2.0F, 0.0F, -1.7F, 4.0F, 0.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = rearrightfoot
		...
		PartDefinition cube_r5 = frontleftfoot
		...
		PartDefinition cube_r6 = frontrightfoot
		...
		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(14, 6).addBox(0.0F, -1.0F, -1.0F, 1.0F, 1.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 0.5F, -0.5F, -0.1745F, 0.0F, 0.0F));
