	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso = body.addOrReplaceChild("torso",
				CubeListBuilder.create().texOffs(0, 10)
						.addBox(-1.5F, -2.5F, -2.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
						.addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
						.addBox(-2.0F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = torso.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 5).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F,
		...
		PartDefinition head = torso.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 2)
						.addBox(0.0F, -0.4F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 9)
						.addBox(-0.5F, -1.4F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, -0.6F, -4.0F));

		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(8, 4).addBox(0.0F, -4.9F, 0.0F, 4.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition tail = torso.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(4, 2)
						.addBox(-0.5F, -0.1F, -0.5F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 0)
						.addBox(-0.5F, 2.7F, 4.3F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, -1.9F, 0.5F));

		PartDefinition cube_r5 = tail.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(4, 0).addBox(0.0F, 0.0F, -1.0F, 1.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 0.6F, 2.2F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r6 = tail
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(-2, 0).addBox(-1.5F, 0.0F, -1.0F, 3.0F, 0.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.2F, 7.1F, 0.5236F, 0.0F, 0.0F));

		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(-2, 0).addBox(-1.5F, 0.017F, 0.0294F, 3.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftleg = body.addOrReplaceChild("leftleg", CubeListBuilder.create(),
				PartPose.offset(0.5F, 0.0F, 0.8F));

		PartDefinition leftleg1 = leftleg.addOrReplaceChild("leftleg1", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.2F));

		PartDefinition cube_r8 = leftleg1.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(4, 5).addBox(0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftleg2 = leftleg1.addOrReplaceChild("leftleg2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.5F, 1.8F));

		PartDefinition cube_r9 = leftleg2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(3, 4).addBox(0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftleg3 = leftleg2.addOrReplaceChild("leftleg3", CubeListBuilder.create(),
				PartPose.offset(0.0F, 1.5F, -2.6F));

		PartDefinition cube_r10 = leftleg3
				.addOrReplaceChild("cube_r10",
						CubeListBuilder.create().texOffs(-2, 4).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition rightleg1 = rightleg.addOrReplaceChild("rightleg1", CubeListBuilder.create(),
		...
		PartDefinition cube_r13 = rightleg3
